...
public class Client_12 {
    ...
    public static void send_command(String cmd) {
        try {
            if (Constant.DEBUG) {
                System.out.println("CMD 12 : " + cmd);
            }
            cmd = cmd + "\r\n";
            Variable.got_reply_12 = false;
            Variable.reply_12 = "";
            temp_rly = "";
            ...
            public void run() {
                try {
                    if (Constant.DEBUG) {
                        ...
                        System.out.println("PORT 12 : " + port);
                    }
                    ...
                    while (((len > -1))) {
                        try {
                            ...
                            if (temp_rly.contains("\r")) {
                                Variable.reply_12 = temp_rly;
                                temp_rly = temp_rly.substring(temp_rly.indexOf("\r") + 1);
                                if (Constant.DEBUG) {
                                    System.out.println("RLY 12  = " + Variable.reply_12);
                                }
                                Variable.got_reply_12 = true;
                            }
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
